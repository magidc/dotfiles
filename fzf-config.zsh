...
#
# Alt-c  - Change directory from current directory
# Alt-v  - Change directory from home
# 
...
export FZF_CTRL_Q_COMMAND='fdfind --follow --exclude .git . $HOME' 
export FZF_ALT_V_COMMAND='fdfind --type d --follow --exclude .git . $HOME' 
